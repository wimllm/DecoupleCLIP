...
from .DecoupleCLIP_transformer import LayerNormFp32, LayerNorm, QuickGELU, Attention, VisionTransformer, TextTransformer
...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, out_layers):
        return self.visual.forward(image, out_layers)
